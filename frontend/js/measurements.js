...
function addSensors(monitorID, monitorName, monitorUrl, sensorId, key, value) {
    var singleSensorDiv = "<div class='measItemRes measAdd' data-sensor-id='"+sensorId+"' data-monitor-url='"+monitorUrl+"' data-monitor-name='"+monitorName+"'>" +
